	...
	return (
		<div className="flex justify-center items-center  h-dvh bg-radial from-blue-800 from-10%  to-black to-90% flex-col  ">
			<div className=" h-3/4 w-1/2 rounded-xl p-6 flex items-center flex-col gap-1 pb-40">
				...
				<button className="text-white mt-auto pt-6  pb-6  pl-8 pr-8 bg-black rounded-full text-2xl hover:-translate-y-2 active:translate-0 transition-all duration-150 hover:shadow-2xl acitve:shadow-md animate-fade-out-scale ">
					Start deploying
				</button>
			</div>
		</div>
