...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-2 rounded-lg border border-white/10 bg-white/[0.03] px-3.5 py-2 text-sm whitespace-nowrap shadow-inner outline-none transition-[color,border-color,box-shadow,background-color]",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer select-none items-center gap-2 rounded-md py-1.5 pl-2 pr-8 text-sm outline-hidden transition-colors",
        "focus:bg-white/[0.06] focus:text-foreground hover:bg-white/[0.06]",
